...
public class Configuration {
    ...
    /**
     * Gets an applying type when omit a type on sql provider annotation(e.g. {@link
    ...
    /**
     * Sets an applying type when omit a type on sql provider annotation(e.g. {@link
     * org.apache.ibatis.annotations.SelectProvider}).
     *
    ...
    protected static class StrictMap<V> extends HashMap<String, V> {
        ...
        /**
         * Assign a function for producing a conflict error message when contains value with the
         * same key.
         * <p>
